export function drawCartesian(context, wDimentions, cDimentions, scale) {
    context.beginPath();
    context.lineWidth = 2;
...
export function drawGrid(context, cDimentions, scale) {
    let xScale = cDimentions.width / scale;
    for (let index = 0; index < scale; index++) {
        context.beginPath();
...
export function drawPoints(context, wDimentions, cDimentions, scale, points, toggleGrid, toggleCartesian) {
...
export function clearScreen(context, wDimentions, cDimentions, scale, toggleGrid, toggleCartesian) {
...
export function clearAll(context, wDimentions, cDimentions, scale, points, toggleGrid, toggleCartesian) {
    clearScreen(context, wDimentions, cDimentions, scale, toggleGrid, toggleCartesian);
    return points = [];
}
